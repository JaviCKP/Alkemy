...
| T3.7 | Integración en el fusor: `min_confidence`, degradación a fallback con aviso, recorte por IR, registro de `source` | M | Tests: LLM propone fuera de enum ⇒ recortado; confianza 0.5 ⇒ fallback + aviso |
